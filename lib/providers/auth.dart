...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDq0-tz7N0-MyRwbLwq3BJEaGQ2QOebTMk'); //Web-API key--runtime constant not compilation constant
    try {
